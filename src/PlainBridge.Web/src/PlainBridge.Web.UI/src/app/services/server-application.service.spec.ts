...
describe('ServerApplicationService', () => {
  ...
  it('should GET list', () => {
    const url = `${environment.apiUrl}/api/ServerApplication`;
  ...
  it('should GET by id', () => {
    const id = 10;
    const url = `${environment.apiUrl}/api/ServerApplication/${id}`;
  ...
  it('should PATCH UpdateState with empty body', () => {
    const id = 5;
    const isActive = true;
    const url = `${environment.apiUrl}/api/ServerApplication/UpdateState/${id}/${isActive}`;
  ...
  it('should send Authorization header when token exists', () => {
    ...
    service.getAllApplications().subscribe();
    const req = httpMock.expectOne(`${environment.apiUrl}/api/ServerApplication`);
